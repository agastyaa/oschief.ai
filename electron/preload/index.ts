...
const electronAPI = {
  ...
  models: {
    ...
    checkQwen3ASR: () => ipcRenderer.invoke('models:check-qwen3-asr') as Promise<boolean>,
    installQwen3ASR: () => ipcRenderer.invoke('models:install-qwen3-asr'),
    uninstallQwen3ASR: () => ipcRenderer.invoke('models:uninstall-qwen3-asr') as Promise<{ ok: boolean; error?: string }>,
