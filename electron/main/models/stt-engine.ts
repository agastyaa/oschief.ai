...
for line in sys.stdin:
    try:
        ...
        kwargs = {"path_or_hf_repo": _model_repo, "language": "en", "word_timestamps": True, "condition_on_previous_text": False, "compression_ratio_threshold": 2.0, "no_speech_threshold": 0.3, "logprob_threshold": -1.0}
        if prompt:
